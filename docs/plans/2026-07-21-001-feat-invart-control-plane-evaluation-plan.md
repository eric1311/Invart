...
- **Constraints:** Official harnesses remain unmodified except through documented extension points; benchmark ground truth cannot enter runtime policy; deterministic critical rules remain monotonic; paid runs require a live-source-revalidated, exact-scope approved budget packet; raw traces remain protected.
...
### Phase B status through 2026-07-24
