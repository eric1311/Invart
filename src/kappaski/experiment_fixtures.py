...
from .experiment_cases import ExpectedControlOutcome, ExperimentCase, ExperimentSeed
...
def validate_experiment_fixture_file(path: Path) -> dict[str, Any]:
    ...
    try:
        ...
        return {"schema_version": "kappaski.experiment_fixture_validation.v0.40", "status": "fail", "path": str(path), "errors": [str(exc)]}
    ...
    return {
        "schema_version": "kappaski.experiment_fixture_validation.v0.40",
...
def validate_experiment_fixture_root(root: Path) -> dict[str, Any]:
    ...
    return {
        "schema_version": "kappaski.experiment_fixture_root_validation.v0.40",
