...
POLICY_AS_CODE_SCHEMA_VERSION = "kappaski.policy_as_code.v0.26"
POLICY_AS_CODE_RESULT_VERSION = "kappaski.policy_as_code_result.v0.26"
...
def test_policy_profile(profile_path: Path) -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix="kappaski_policy_as_code_") as tmp:
        root = Path(tmp)
        ...
        return {
            "schema_version": "kappaski.policy_as_code_test.v0.26",
