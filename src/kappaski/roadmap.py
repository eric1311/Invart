...
CAPABILITIES: tuple[RoadmapCapability, ...] = (
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/models.py", "src/kappaski/runtime.py", "src/kappaski/ledger.py", "src/kappaski/postruntime.py", "src/kappaski/cli.py"],
        ...
        docs=["docs/kappaski-v0.1-prototype-design.html", "docs/proof-workflow-v0.1.md"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/review.py", "src/kappaski/policy.py", "src/kappaski/runtime.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/daemon.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/corpus.py", "src/kappaski/scanner.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/gate.py", "src/kappaski/cli.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/adapter.py", "src/kappaski/cli.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/approval.py", "src/kappaski/replay.py", "src/kappaski/cli.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/review.py", "src/kappaski/evidence.py", "src/kappaski/policy.py"],
    ...
    RoadmapCapability(
        ...
        target="Run real SWE-Bench Lite harness workflows under Kappaski without breaking exit code, artifacts, or grading result while preserving safety evidence.",
        status="implemented",
        implementation=["src/kappaski/harness.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/adapter_profiles.py", "src/kappaski/claude_adapter.py", "src/kappaski/scanner.py", "src/kappaski/cli.py"],
        ...
        product_boundaries=["Local wrapper/hook JSONL bridge exists, real-binary environment checks are implemented, and process-group supervision captures PID/PGID control metadata.", "Vendor-stable Claude Code hook behavior can still change outside Kappaski's release cycle."],
        evidence_level="unit_cli_local_runtime",
        external_validation="not_run_optional",
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/profiles.py", "src/kappaski/cli.py", "src/kappaski/gate.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/teamrun.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/enforcement.py", "src/kappaski/cli.py", "rust/kappaski-shim/Cargo.toml", "rust/kappaski-shim/src/main.rs"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/audit_demo.py", "src/kappaski/cli.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/native.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        target="Normalize native hook/plugin events into Kappaski Invocation records and render blocking responses for supported agents.",
        status="implemented",
        implementation=["src/kappaski/native_bridge.py", "src/kappaski/cli.py"],
        ...
        product_boundaries=["Bridge payloads are deterministic fixture-compatible and response-shape fuzzing covers Claude Code, Codex, OpenCode, and generic contracts.", "Live vendor hook behavior can still change outside Kappaski's release cycle."],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/mcp_broker.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/coverage.py", "src/kappaski/runtime.py", "src/kappaski/postruntime.py", "src/kappaski/gate.py", "src/kappaski/profiles.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/identity.py", "src/kappaski/daemon.py", "src/kappaski/postruntime.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/path_graph.py", "src/kappaski/postruntime.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/path_policy.py", "src/kappaski/policy.py", "src/kappaski/cli.py"],
        ...
        product_boundaries=["Uses Kappaski-native profile predicates now; Rego/Cedar compatibility remains future work."],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/mediation.py", "src/kappaski/coverage.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/profiles.py", "src/kappaski/replay.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/pre_v1.py", "src/kappaski/evals.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        target="Validate and execute Kappaski-native TOML policy profiles with path predicates and deterministic critical rules that LLM review cannot downgrade.",
        status="implemented",
        implementation=["src/kappaski/policy_as_code.py", "src/kappaski/path_policy.py", "src/kappaski/cli.py"],
        ...
        next_step="Add migration helpers if enterprise users need to map existing policy catalogs into Kappaski-native profiles.",
    ),
    RoadmapCapability(
        version="v0.27",
        ...
        status="implemented",
        implementation=["src/kappaski/evidence_bundle.py", "src/kappaski/cli.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/benchmark_registry.py", "src/kappaski/evals.py", "src/kappaski/cli.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/release_candidate.py", "src/kappaski/cli.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/experiment_cases.py", "src/kappaski/cli.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/corpus_adapters/agentdojo.py", "src/kappaski/corpus_adapters/agentdyn.py", "src/kappaski/experiment_cases.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/corpus_adapters/agentsecbench.py", "src/kappaski/experiment_cases.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/experiment_cases.py", "src/kappaski/harness.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/corpus_adapters/skill_inject.py", "src/kappaski/experiment_cases.py", "src/kappaski/scanner.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/secure_code_gate.py", "src/kappaski/evals.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/coverage_experiments.py", "src/kappaski/coverage.py"],
        ...
        product_boundaries=["The matrix verifies Kappaski's own coverage claims; it is not a kernel-level enforcement claim."],
        claim_scope="local_experiment_substrate",
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/reviewer_experiments.py", "src/kappaski/review.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/audit_experiments.py", "src/kappaski/ledger.py", "src/kappaski/evidence_bundle.py"],
    ...
    RoadmapCapability(
        ...
        status="implemented",
        implementation=["src/kappaski/harness.py", "src/kappaski/cli.py", "src/kappaski/evals.py"],
...
FUTURE_CAPABILITIES: tuple[RoadmapCapability, ...] = (
    RoadmapCapability(
        ...
        status="planned",
        product_boundaries=["Recorded for roadmap continuity only; not part of v0.40 implementation readiness."],
    ),
)
...
def summarize_roadmap_coverage() -> dict[str, Any]:
    ...
    return {
        "schema_version": "kappaski.roadmap_coverage.full_product.v0.40",
