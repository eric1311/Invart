...
class Session:
    ...
    def from_dict(cls, payload: dict[str, Any]) -> "Session":
        return cls(
            ...
            policy_version=str(payload.get("policy_version", "kappaski.policy.v0.1")),
...
class LedgerEntry:
    ...
    prev_hash: str = ""
    entry_hash: str = ""
    schema_version: str = "kappaski.ledger.v0.1"
    ...
    def from_dict(cls, payload: dict[str, Any]) -> "LedgerEntry":
        return cls(
            ...
            schema_version=str(payload.get("schema_version", "kappaski.ledger.v0.1")),
...
class PolicyEvaluation:
    ...
    def from_dict(cls, payload: dict[str, Any]) -> "PolicyEvaluation":
        return cls(
            ...
            policy_version=str(payload.get("policy_version", "kappaski.policy.v0.2")),
