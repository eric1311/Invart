...
BENCHMARK_SUITES: tuple[dict[str, Any], ...] = (
    ...
    {"suite": "v0.9.14-gateway-server-evidence", "version": "v0.9.14", "category": "evidence", "optional_heavy": False, "claim_scope": "gateway_server_evidence", "evidence_level": "local_vendor_gateway_fixture_plus_managed_launcher"},
    {"suite": "v0.9.15-enterprise-registration-authority", "version": "v0.9.15", "category": "governance", "optional_heavy": False, "claim_scope": "enterprise_registration_authority", "evidence_level": "local_registry_launcher_and_inventory_fixture"},
    {"suite": "v0.9.16-public-control-plane-slice", "version": "v0.9.16", "category": "evaluation", "optional_heavy": False, "claim_scope": "public_control_plane_slice", "evidence_level": "local_pinned_agent_workflow_slice"},
    {"suite": "v0.9.17-benign-coding-friction", "version": "v0.9.17", "category": "compatibility", "optional_heavy": False, "claim_scope": "benign_coding_friction", "evidence_level": "paired_local_baseline_vs_managed_artifacts"},
