...
from invart.evaluation.experiment_cases import run_experiment_case, cases_for_suite
...
def run_audit_tamper_assurance(*, out_dir: Path | None = None) -> dict[str, Any]:
    root = (out_dir or Path(tempfile.mkdtemp(prefix="invart_audit_tamper_"))).expanduser().resolve()
    ...
    report = {
        "schema_version": "invart.audit_experiments.v0.38",
