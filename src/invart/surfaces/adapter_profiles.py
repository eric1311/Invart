...
_PROFILES: tuple[AgentAdapterProfile, ...] = (
    ...
    AgentAdapterProfile(
        ...
        coverage_grade="native_event_bridge",
        claim_boundary="OpenCode plugin and agent surfaces are mediated only when their hook payloads enter Invart; plugin-only logs are not full runtime enforcement.",
        required_artifacts=["ledger", "proof", "coverage", "audit"],
