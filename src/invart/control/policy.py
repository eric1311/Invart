...
from invart.core.models import Finding, Invocation, PolicyDecision, PolicyEvaluation, SemanticReview, TaintState, utc_now
from invart.control.rules import highest_severity, is_write_like_action
...
def merge_policy(
    ...
    *,
    ...
    policy_version: str = "invart.policy.v0.2",
