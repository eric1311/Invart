...
from invart.core.ledger import append_ledger_entry
...
def run_enterprise_audit_demo(out_dir: Path) -> dict[str, Any]:
    ...
    return {
        "schema_version": "invart.enterprise_audit_demo.v0.14",
        "ledger": str(ledger),
...
def build_enterprise_audit_report(
    ...
    return {
        "schema_version": "invart.enterprise_audit.v0.14",
...
def record_audit_signoff(
    ...
    *,
    ...
    signoff = {
        "schema_version": "invart.audit_signoff.v0.14",
