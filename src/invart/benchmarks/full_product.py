...
from invart.governance.teamrun import append_teamrun_fact, create_handoff, create_teamrun, export_teamrun_timeline_html
from invart.surfaces.enforcement import run_enforced_command
from invart.assurance.audit_demo import record_audit_signoff, run_enterprise_audit_demo
...
from invart.evaluation.product_readiness import optional_provider_smoke, reviewer_quality_corpus
...
def run_full_product_readiness_benchmark() -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix="invart_full_product_") as tmp:
        root = Path(tmp)
        ...
        v41 = run_unmanaged_agent_inventory_benchmark()
        v42 = run_managed_launcher_migration_benchmark()
        v43 = run_enterprise_coverage_gate_benchmark()
        v44 = run_external_evidence_and_swebench_benchmark()
        v45 = run_final_demo_and_rc_gate_benchmark()
        progressive = run_progressive_external_validation_benchmark()
        ...
        checks = {
            ...
            "v41_unmanaged_agent_inventory": v41["passed"] is True,
            "v42_managed_launcher_migration": v42["passed"] is True,
            "v43_enterprise_coverage_gate": v43["passed"] is True,
            "v44_external_evidence_and_swebench": v44["passed"] is True,
            "v45_final_demo_and_rc_gate": v45["passed"] is True,
            "progressive_external_validation": progressive["passed"] is True,
        }
