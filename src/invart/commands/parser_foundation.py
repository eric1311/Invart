...
def register_foundation_commands(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    record.add_argument("--ledger", "--log", default=".invart/session.jsonl", help="JSONL ledger path.")
    ...
    shell.add_argument("--ledger", "--log", default=".invart/session.jsonl", help="JSONL ledger path.")
    ...
    policy_validate = policy_sub.add_parser("validate", help="Validate a Invart-native policy-as-code profile.")
    ...
    proof_export.add_argument("--ledger", "--events", default=".invart/session.jsonl")
